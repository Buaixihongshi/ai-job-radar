...
| Agent评测 | Agent/大模型效果评测、Benchmark建设 | 25 |
| AI/Agent产品 | AI策略产品、Agent产品、AIGC产品 | 23 |
...
_Agent评测 10 / 大模型/AI测试 3 / AI/Agent产品 3 / 测试开发(AI方向) 1_
...
| 岗位 | 方向 | 城市 | 部门 |
| --- | --- | --- | --- |
| [大模型评测专家](https://zhaopin.meituan.com/social-recruitment/4387197037) | Agent评测 |  |  |
...
*数据自动采集，更新于 2026-04-16 10:37。仅供求职参考。*
