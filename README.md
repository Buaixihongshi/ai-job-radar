...
| 方向 | 说明 | 岗位数 |
| --- | --- | --- |
| 大模型/AI测试 | 大模型评测、算法测试、AI质量保障 | 6 |
| 测试开发(AI方向) | AI方向的测试开发、评测平台、自动化框架 | 15 |
| Agent评测 | Agent/大模型效果评测、Benchmark建设 | 24 |
| AI/Agent产品 | AI策略产品、Agent产品、AIGC产品 | 21 |
...
| 公司 | 状态 | 岗位数 |
| --- | --- | --- |
| [阿里巴巴](jobs/阿里巴巴.md) | ✅ 已接入 | 16 |
| [腾讯](jobs/腾讯.md) | ✅ 已接入 | 15 |
| [百度](jobs/百度.md) | ✅ 已接入 | 15 |
...
**✅ 已接入（6 家）**：[阿里巴巴](jobs/阿里巴巴.md)、[腾讯](jobs/腾讯.md)、[百度](jobs/百度.md)、[快手](jobs/快手.md)、[小红书](jobs/小红书.md)、[网易](jobs/网易.md)

**🔧 调试中（3 家）**：字节跳动、滴滴、美团（爬虫已编写，数据接入调试中）
...
### [快手](jobs/快手.md)（15 个岗位）

_Agent评测 10 / 大模型/AI测试 3 / 测试开发(AI方向) 1 / AI/Agent产品 1_
...
_AI/Agent产品 8 / Agent评测 4 / 测试开发(AI方向) 3_
...
*数据自动采集，更新于 2026-04-15 23:53。仅供求职参考。*
